...
const steps: Step[] = [
  {
    ...
    details: [
      {
        icon: Target,
        text: "Identify the most important goals for your business and where to focus efforts for maximum impact",
      },
      {
        icon: Search,
        text: "Get clear insights from data about how well your checkout or lead capture is performing, and see what competitors are doing",
      },
      {
        icon: Lightbulb,
        text: "Understand the complete customer journey and find where people are getting stuck or frustrated",
      },
    ],
  },
  {
    ...
    details: [
      {
        icon: Map,
        text: "Simplify your messaging and make it easier for customers to find what they need and complete their purchase or enquiry",
      },
      {
        icon: Signpost,
        text: "Design layouts that remove obstacles and naturally guide people towards buying or getting in touch",
      },
      {
        icon: MousePointer2,
        text: "Build working prototypes to test ideas before investing in full development",
      },
    ],
  },
  {
    ...
    details: [
      {
        icon: Sparkles,
        text: "Make quick improvements that boost conversions straight away",
      },
      {
        icon: FlaskConical,
        text: "Test different versions to ensure every change actually improves results",
      },
      {
        icon: Ruler,
        text: "Track how improvements directly increase revenue and customer value",
      },
    ],
  },
];
  ...
  return (
    <div className={cn("container mx-auto px-4 md:px-6", className)}>
      <div className="flex max-w-xl flex-col items-center gap-4 text-center mx-auto mb-12">
        <p className="text-sm font-medium text-foreground">3 phase approach</p>
        <h2 className="text-4xl font-bold tracking-tight text-foreground">
          Move from UI friction to better ROI
        </h2>
        <p className="text-base text-foreground">
          Take your journey pain points and turn things around to a better ROI
        </p>
      </div>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                "lg:h-[600px]",
                isOpen
                  ? "lg:flex-[3] ring-2 ring-primary/20 shadow-lg bg-card/80"
                  : "lg:flex-1 hover:bg-card/80 hover:border-primary/30 hover:shadow-md"
              )}
            >
              <button
                onClick={(e) => {
                    ...
                    <FaIcon
                      ...
                      className={cn(
                        ...
                        isOpen
                          ...
                          : "opacity-70 scale-90 group-hover:scale-100 group-hover:opacity-100"
                      )}
                    />
                  </div>
                  {/* Mobile Icon */}
                ...
                <div
                  className={cn(
                    ...
                    isOpen
                      ...
                      : "lg:opacity-0 lg:invisible lg:h-0"
                  )}
                >
