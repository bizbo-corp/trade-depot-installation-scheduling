...
export function PurposeWheel({ className }: PurposeWheelProps) {
  return (
    <div className={cn("relative size-[768px]", className)}>
      <svg
        width="838"
        height="838"
        viewBox="0 0 838 838"
      ...
      >
        {/* Top right segment - uses --background-2 */}
        <path
        ...
        />
        {/* Bottom right segment - uses --background-3 */}
        <path
        ...
        />
        {/* Bottom left segment - uses --background-4 */}
        <path
        ...
        />
        {/* Top left segment - uses --background-3 */}
        <path
